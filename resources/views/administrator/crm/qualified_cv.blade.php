                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" style="background-color: purple">
                                <h3 class="card-title" style="color: white">Qualified Staff Cvs</h3>
...
@section('script')
    ...
    <script>
        ...
        var columns = [
            ...
            { "data":"app_job_title", "name": "app_job_title" },
            ...
            if (details) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#crm_qualified_cv_sample').DataTable().ajax.reload();
