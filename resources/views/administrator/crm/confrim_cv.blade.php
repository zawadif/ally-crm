                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" style="background-color: purple">
                                <h3 class="card-title" style="color: white">Confirmation Cvs</h3>
...
@section('script')
    ...
    <script>
        ...
        var columns = [
            ...
            { "data":"schedule_search", "name": "schedule_search"  ,"orderable": false, "searchable": false},
