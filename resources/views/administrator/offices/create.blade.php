...
@section('title','Franchises Create Management')
@section('style')
...
{{--                                                            <i class="icon-cross"></i> --}}
                                        ...
                                        <div class="card-body">
                                            <form id="submitData" method="POST" action="{{ route('offices.store') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div>
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <label for="app_name" class="form-label">Franchises Name</label>
                                                            <input type="text" class="form-control" id="office_name" name="office_name" value="{{old('office_name')}}">
                                                            <span id="office_name_error" class="text-danger"></span>

                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="app_email" class="form-label">Franchises Email</label>
                                                            <input type="text" class="form-control" id="office_email" name="office_email" value="{{old('office_email')}}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="tel" class="form-control" id="office_phone" name="office_phone" value="{{old('office_phone')}}">
                                                            <span id="office_phone_error" class="text-danger"></span>

                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="app_phoneHome" class="form-label">Franchises Land Line</label>
                                                            <input type="tel" class="form-control" id="office_phoneHome" name="office_phoneHome" value="{{old('office_phoneHome')}}">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="office_postcode" name="office_postcode" value="{{old('office_postcode')}}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="office_website" name="office_website" value="{{old('office_website')}}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control" id="office_notes" name="office_notes" rows="3"></textarea>
