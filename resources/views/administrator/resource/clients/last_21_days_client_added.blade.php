                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" style="background-color: purple">
                                <h3 class="card-title" style="color: white">Client 7 days Added</h3>
                            ...
                            <!-- /.box-header -->
                            <div class="card-body">
                                <table class="table table-hover table-striped" id="last_7_days_sample">
                                    <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Time</th>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#last_7_days_sample').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax":"getlast21DaysApp",
                "order": [[ 0, 'desc' ]],
                "columns": [
