                    ...
                    <div class="col">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header" style="background-color: purple">
                                <h3 class="card-title" style="color: white">Resource Job Specialist Staff </h3>
                            ...
                            <!-- /.box-header -->
                            <div class="card-body">
                                <table class="table" id="non_nurse_special_job_table_1">
                                    <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Time</th>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#non_nurse_special_job_table_1').DataTable({
