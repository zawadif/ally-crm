                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="submitData" method="POST" action="{{ route('units.update',$unit->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PATCH')
                                                <div>
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="contact_name" name="contact_name" value="{{ $unit->contact_name }}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="tel" class="form-control" id="office_phone" name="office_phone" value="{{ $unit->contact_phone_number }}">
                                                            <span id="office_phone_error" class="text-danger"></span>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="office_phoneHome" class="form-label">Contact Landline</label>
                                                            <input type="tel" class="form-control" id="office_phoneHome" name="office_phoneHome" value="{{ $unit->contact_landline}}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" id="head_office" name="head_office">
                                                                @foreach($head_offices as $office)
                                                                    <option value="{{$office->id}}" {{ $unit->head_office == $office->id ? 'selected' : '' }}>
                                                                        {{ ucfirst($office->name) }}
                                                                    </option>
                                                                @endforeach
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" id="office_postcode" name="office_postcode" value="{{ $unit->unit_postcode }}">
                                                            <span id="office_postcode_error" class="text-danger"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <label for="contact_name" class="form-label">Unit Email</label>
                                                            <input type="text" class="form-control" id="office_email" name="office_email" value="{{ $unit->contact_email }}">
                                                            <span id="office_email_error" class="text-danger"></span>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="office_website" class="form-label">Website</label>
                                                            <input type="text" class="form-control" id="office_website" name="office_website" value="{{ $unit->website }}">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control" id="unit_notes" name="unit_notes" rows="3">{{ $unit->unit_notes }}</textarea>
