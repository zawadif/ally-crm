<section class="content px-1">
    ...
    <div class="row p-1">
        ...
        <div class="col-lg-4 col-md-6 d-flex justify-content-start">
            ...
            <input class="" type="search" id="proposalSearch" placeholder="Search" name="proposalSearch"
            ...
            <div class="card-header" style="background-color: purple">
                <div class="row p-1">
                    <div class="col-lg-10 col-md-6 d-flex justify-content-start ">
                        <span class="pl-2 text-white">{{ $user->fullName }}'s Proposals</span>
                    </div>
                    <div class="col-lg-2 col-md-6 text-white" style="float: right !important">
                        <span id="proposals_info" class="pl-2 proposals_table_info"></span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xlg-12 col-lg-12 table-responsive">
                    <table class="table table-striped table-borderless" id="proposals-table"
