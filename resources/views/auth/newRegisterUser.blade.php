        ...
        <div class="half mr-lg-5" style="width: 100%;padding-top:50px;padding-bottom:20px" data-aos="fade-right">
            <div class="row">
                ...
                <div class="col-lg-12">
                   ...
                   @endif
                    <form class="mt-3" id="newRegistrationUser" action="{{ url('/register')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-2 mb-2">
                            <div class="col-lg-12 d-flex justify-content-start">
                                ...
                                <label class="mt-4">
                                    ...
                                    <br><span style="color:white;    padding-left: 22px;"><small>.jpeg, .jpg and .png </small></span>
                                </label>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-1">
                                    ...
                                    <div class="input-group date" id="dateOfBirthPicker" data-target-input="nearest">
                                        <input type="hidden" name="18years" id="18years" value="567648000">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  mb-1">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" id="country" name="country" class="form-control inputFieldHeight borderLeftNone font12" value="{{ old('country') }}" placeholder="Enter Country">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group  mb-1">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" id="postalCode" name="postalCode" class="form-control inputFieldHeight borderLeftNone font12" maxlength="10" value="{{ old('postalCode') }}" placeholder="Enter Postal Code">
                                        <span class="invalid-feedback hide text-danger" style="display: block;" role="alert" id="error-postalcode"> &nbsp; &nbsp;<b> Invalid postal code </b></span>
                                    </div>
                                </div>
                        ...
                        <input type="submit" class="mt-5 mb-5 font12 btn btn-block btn-success btn-lg rounded greenButton" value="Continue">
                    </form>
                </div>
            </div>
        </div>
