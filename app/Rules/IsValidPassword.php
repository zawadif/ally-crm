    ...
    public function message()
    {
        ...
        switch (true) {
            case $this->requireUppercase
                ...
                return __('The :attribute must be at least :length characters and contain at least one uppercase character,one lower character, one number, and one special character.', [
                    'length' => $this->length,
                ]);
